...
router.get('/listarCategoriaItens', (req, res)=>{
...
router.get('/listarCategoriaItens/:id',(req, res)=>{
...
router.post('/inserirCategoriaItens', (req, res)=>{
...
router.put('/alterarCategoriaItens', (req, res)=>{
...
router.delete('/excluirCategoriaItens/:id', (req, res)=>{
